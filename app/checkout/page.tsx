  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-slate-900 flex flex-col justify-between">
      ...
      <main className="max-w-6xl mx-auto w-full p-6 sm:p-10 my-6">
        ...
        {submitted ? (
          /* Thank You Screen */
          <div className="max-w-lg mx-auto rounded-3xl border border-slate-200/90 bg-white p-8 sm:p-12 text-center shadow-xl shadow-slate-200/50">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-500 text-white shadow-lg shadow-emerald-500/30 mb-6">
              <CheckCheck size={32} />
            </div>
            <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 border border-emerald-100 px-3 py-1 text-xs font-bold text-emerald-700 mb-3">
              Subscription Active
            </span>
            ...
            <p className="mt-3 text-xs sm:text-sm leading-relaxed text-slate-600">
              We have activated the <strong>{currentPlan.name} Plan</strong> for <strong>{companyName || firstName || "your organization"}</strong>. Your official receipt and login activation details have been dispatched to <strong>{email || "your email"}</strong>.
            </p>
            <div className="mt-8 pt-6 border-t border-slate-100 space-y-3">
              <Link
                href="/"
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 py-3 text-xs font-bold text-white shadow-md transition hover:bg-slate-800"
              >
                Return to Home
          ...
          /* 2-Column Checkout Layout (Matching Attached Screenshot) */
              ...
              <form onSubmit={handleSubscribe} className="lg:col-span-7 space-y-7">
                ...
                <div>
                  <button
                    ...
                    className="w-full rounded-xl bg-[#00A3FF] py-3.5 text-sm font-bold text-white shadow-md shadow-sky-500/20 transition-all hover:bg-[#0092E5] active:scale-[0.99] disabled:opacity-70 cursor-pointer"
                  >
                    {isProcessing ? "Processing Subscription..." : "Subscribe"}
                  </button>
